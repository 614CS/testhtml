 ...
 //<!-- invocar js de supabase -->   
  src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.101.1/dist/umd/supabase.min.js"
  ...
  async function getData() {      
    ...
    if (error) console.error('Error getting data:', error)
