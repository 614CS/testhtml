...
// src/index.js
const DATABASE_URL = "postgresql://neondb_owner:npg_k0bzlBWySP3D@ep-divine-haze-akvab75y.c-3.us-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
var index_default = {
  async fetch(request, env, ctx) {
    const client = new ut(DATABASE_URL);
    try {
